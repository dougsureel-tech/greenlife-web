  ...
  return (
    <footer className="bg-green-950 text-green-200">
          ...
          <ul className="space-y-1.5">
            {STORE.hours.map((h) => (
              <li key={h.day} className="flex justify-between text-xs gap-4">
                ...
                <span className="text-green-200/80 tabular-nums">{h.open}–{h.close}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="border-t border-green-900/60 py-5 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-green-800">

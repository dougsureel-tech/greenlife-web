  ...
  if (node.slug) {
    ...
    return (
      <a
        ...
        className="cursor-pointer hover:brightness-110 transition-[filter] focus:outline-none focus-visible:[outline:2px_solid_#16a34a] focus-visible:[outline-offset:2px]"
      >
        {content}
      </a>
    );

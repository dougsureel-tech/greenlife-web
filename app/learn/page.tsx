...
async function UserStateAwareLearn() {
  ...
  return (
    <>
      <p className={`text-xs ${userId ? "text-emerald-300/80" : "text-zinc-400"}`} data-userstate="resolved">
        {userId
...
export default function LearnPage() {
  return (
    <div className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-emerald-900/40 bg-gradient-to-br from-emerald-950 via-zinc-950 to-zinc-950 px-6 sm:px-10 py-10 sm:py-14">
        <div
      ...
      <section className="space-y-4">
        ...
        <div>
          <Link
            href="/learn/terpenes"
            className="inline-flex items-center gap-2 rounded-full border border-emerald-800/60 bg-emerald-950/40 hover:border-emerald-600 hover:bg-emerald-900/50 px-4 py-2 text-sm font-semibold text-emerald-100 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus-visible:outline-none"
          >
      ...
      <section className="text-center py-4">
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-3">
          <Link
            href="/menu"
            className="inline-flex items-center gap-1.5 rounded-full bg-emerald-700 hover:bg-emerald-600 px-6 py-3 text-sm font-semibold text-white"
          >
            Browse the menu →
          </Link>
          <Link

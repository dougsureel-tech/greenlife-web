    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, position: "relative" }}>
          ...
          />
          <span style={{ fontSize: 24, fontWeight: 700, letterSpacing: 4, textTransform: "uppercase", color: "#86efac" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, position: "relative" }}>
          ...
          <div style={{ fontSize: 36, color: "#bbf7d0", fontWeight: 500, maxWidth: 900 }}>
            {STORE.tagline}
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", position: "relative" }}>
          ...
          <div style={{ fontSize: 20, color: "#86efac", fontWeight: 500 }}>

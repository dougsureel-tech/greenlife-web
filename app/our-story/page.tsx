...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/our-story/opengraph-image", width: 1200, height: 630, alt: `${STORE.name}` }],
  },
};
...
const breadcrumbSchema = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  "@id": `${STORE.website}/our-story#breadcrumb`,
  itemListElement: [
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-green-950 via-emerald-950 to-green-950 text-white py-12 sm:py-16">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-emerald-100/80 mt-4 text-base sm:text-lg leading-relaxed max-w-2xl">
            We&apos;re a small Wenatchee cannabis shop on {STORE.address.street.split(",")[0]}.

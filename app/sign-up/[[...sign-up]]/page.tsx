...
// Sister of the sign-in fix + inv v396.645 + glw v23.705. Pre-fix any
// attacker-controlled URL flowed into Clerk's `fallbackRedirectUrl`,
// triggering an off-origin redirect after successful sign-up.

...
**Q: Who runs ${name}?**
A: ${name} is operated by Verve Mgmt LLC. Founded 2014 in the same building in Sunnyslope it operates from today — known for the Valley's best cannabis staff.

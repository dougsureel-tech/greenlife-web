    ...
    <>
      ...
      <div className="relative overflow-hidden bg-green-950 text-white py-10 sm:py-14">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-green-300/70 mt-2 text-sm sm:text-base">Call, email, or stop in — whichever&apos;s easiest.</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  // Subject prefill so the team can triage incoming email
                  // at a glance. Hosts that don't honor `?subject=` ignore
                  // the param — worst case the customer sees an unprefilled
                  // email, no breakage.
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-stone-400 text-center">
            21+ · Cash only · ATM available on-site · Valid ID required
          </p>
        </div>
      </div>
    </>

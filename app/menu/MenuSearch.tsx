          ...
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 flex-1">
            ...
            {categories.map((c) => {
              ...
              return (
                ...
                >
                  {c.name}
                  <span className={`ml-1.5 tabular-nums ${isActive ? "text-green-200" : "text-stone-400"}`}>{count}</span>
                </button>
              );
            })}
          </div>
                  ...
                  return (
                    <button
                      ...
                      className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold border transition-all ${
                        on ? "bg-green-700 text-white border-green-700" : "bg-white text-stone-700 border-stone-200 hover:border-green-300"
                      }`}
                    >
